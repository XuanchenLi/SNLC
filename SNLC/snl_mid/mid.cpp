...
void GenCode(vector<Argnode>& vec, string codekind, ArgRecord* arg1, ArgRecord* arg2, ArgRecord* arg3)//1.7 生成中间代码
{
    string op = codekind;
...
{
    //ASTNodeBase* t = ttt
    ASTNodeBase* t = ttt->child[0];//注意此处结构有所不同
